...
var guestslist = ["Alice", "Bob", "Emily", "johnson",];
//adding two guest
...
while (guestslist.length > 2) {
    ...
    if (removedGuest !== undefined) {
        console.log("Sorry, ".concat(removedGuest, ", you can't be invited for dinner."));
    }
}
console.log(guestslist);
// print mesage invitation of 2 guest
guestslist.forEach(function (guest) {
    console.log("Dear ".concat(guest, ", both you are invited for dinner"));
});
